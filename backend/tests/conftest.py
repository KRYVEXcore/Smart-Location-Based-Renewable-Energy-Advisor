...
def db_session():
    ...
    # SQLite ignores foreign keys (including ON DELETE CASCADE) unless this
    # is enabled per-connection — without it, FK-constraint bugs like a
    # missing cascade wouldn't be caught by tests at all.
