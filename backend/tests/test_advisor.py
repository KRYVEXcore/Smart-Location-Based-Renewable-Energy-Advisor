...
def _setup(db_session, provider, *, state="Tamil Nadu", wind_error=None, settings=None, solar_provider=None):
    ...
    if solar_provider:
        overrides["solar_provider"] = solar_provider
...
def test_system_prompt_states_the_authority_and_boundary_rules():
    for rule in (
        ...
        "no roi, financing, loan or future-tariff result",
